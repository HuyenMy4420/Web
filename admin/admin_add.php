...
if(isset($_POST["saveproduct"])){
 ...
 $sql = "INSERT INTO product(id,image,name,price,supplier,description,category_int) VALUES('$id','$file_name','$name', '$price','$supplier','$description','$category_int')";
    ...
    <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <label class="control-label col-sm-2" for="pl" style="text-align:left">Nhà cung cấp</label>
                <div class="col-sm-3">
                  <input type="text" class="form-control" name="supplier" id="supplier" placeholder="Nhập nhà cung cấp">
                </div>
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="msp" style="text-align:left">Mã sản phẩm</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="id" id="id" placeholder="Nhập mã sản phẩm">
                  </div>
            ...
            <label class="control-label col-sm-2" for="anh" style="text-align:left">Ảnh sản phẩm</label>
                ...
                <div class="col-sm-3">
                  ...
                  <button class="btn btn-success" name="saveproduct" style="margin-left:139px;background-color:#AF3FCB">Lưu</button>
                </div>
            </div>
