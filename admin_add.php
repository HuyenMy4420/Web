  ...
  <div class="row content">
    ...
    <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <label class="control-label col-sm-2" for="pl" style="text-align:left">Phân loại sản phẩm</label>
                <div class="col-sm-3">
                  <input type="text" class="form-control" name="Type" id="Type" placeholder="Nhập phân loại">
                </div>
